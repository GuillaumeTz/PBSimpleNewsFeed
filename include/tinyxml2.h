...
public:
	...
	/** Given an attribute name, Attribute() returns the value
		...
		@endverbatim
	*/
	const char* AttributeIsEqual( const char* name, const char* value = 0 ) const;

	const char* GetAttribute(const char* name, const char* defaultValue ) const;

	int GetAttribute(const char* name, int defaultValue ) const;
...
public:
	...
	const char* GetText() { XMLElement* Element = ToElement(); if (Element && Element->GetText()) return Element->GetText(); return ""; }
